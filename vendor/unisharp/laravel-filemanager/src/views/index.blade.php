@php
    $type_avail = count($helper->availableMimeTypes()) === 0 ? 
    null : 
    implode(',', $helper->availableMimeTypes());
@endphp
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <script>
    ...
    @endif
    @if(Request::has("default_load"))
      $(document).ready(function() {
        goTo("{{ Request::get("default_load") }}")
      })
    @endif
  </script>
</body>

...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                <input type='submit' name="submit_btn" class='btn btn-primary btn-block mb-2' value='Save' >
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="blog_posted_at" aria-describedby="blog_posted_at_help"
                        type="text"
                        name='posted_at'

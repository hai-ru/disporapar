...
@section("content")
    ...
    @forelse($post_translations as $post)
        <div class="card m-4" style="">
            <div class="card-body">
                <h5 class='card-title'><a class="a-link-cart-color" href='{{ route("pages",$post->slug) }}'>{{$post->title}}</a></h5>
                ...
                <a href="{{$post->url(app()->getLocale())}}" class="card-link btn btn-outline-secondary"><i class="fa fa-file-text-o"
                                                                                                                       aria-hidden="true"></i>
                    View Post</a>

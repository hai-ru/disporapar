...
return [
    ...
    'captcha' => [
        ...
        'basic_question' => "Apa lawan dari putih?", // a simple captcha question to always ask (if captcha_type is set to 'basic'
        'basic_answers' => "hitam,gelap", // comma separated list of possible answers. Don't worry about case.
    ],
...
//             You must enter the whole url (but not the "s.src = '" part!)
            'src_url' => "https://disporapar-kalbar.disqus.com/embed.js", // enter the url here, from the html snippet disqus provides
